package com.dalel.words.adapter
...
import com.dalel.words.DetailActivity
import com.dalel.words.R
...
class WordAdapter(private val letterId: String, context: Context) :
    ...
    override fun onBindViewHolder(holder: WordViewHolder, position: Int) {
        ...
        holder.button.setOnClickListener {
            ...
            //val queryUrl: Uri = Uri.parse("tel:98000000")
            //val queryUrl: Uri = Uri.parse("https:youtybe.com")
        }
